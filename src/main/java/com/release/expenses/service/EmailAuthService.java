...
public class EmailAuthService {
    ...
    public String generateOtp(AuthReqDTO authObj) throws InvalidAlgorithmParameterException, NoSuchPaddingException, IllegalBlockSizeException, NoSuchAlgorithmException, BadPaddingException, InvalidKeyException, MessagingException, UnsupportedEncodingException {
        if(!validateEmail(authObj.mobileNumber().trim())){
            throw new InvalidIdentifierException("Invalid Email !");
        }
